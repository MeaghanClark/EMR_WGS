...
date=$(date +%m%d%Y)
jobname=test_overlap #label for SLURM book-keeping 
array_key=/mnt/research/Fitz_Lab/projects/massasauga/EMR_WGS/scripts/keys/trimmed_reads.txt
...
executable=/mnt/research/Fitz_Lab/projects/massasauga/EMR_WGS/scripts/test_overlap.sbatch #script to run 
