...
# define variables
BCF='/mnt/research/Fitz_Lab/projects/posk/variants/raw_calls/EMR_WGS_03222023_norm.bcf.gz'
OUTFILE='/mnt/research/Fitz_Lab/projects/posk/variants/masks/EMR_norm.vcfstats'
