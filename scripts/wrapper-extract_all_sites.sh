...
# Last updated 09/13/2024 by MI Clark, script format inspired by R Toczydlowski 
...
executable=/mnt/research/Fitz_Lab/projects/massasauga/EMR_WGS/scripts/extract_all_sites.sbatch
